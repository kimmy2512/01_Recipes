...
while stop != "xxx":
    ...
    # Stop looping if exit code is type and there are more than 2 ingredients...
    if amount.lower() == "xxx" and len(ingredients) > 1:
        break
    elif amount.lower() == "xxx" and len(ingredients) < 2:
        print("You need at least two ingredients in the list. Please add more ingredients. ")
    ...
    # If exit code is not entered, add ingredient to list
        ...
        # Remove decimal point for wqhole numbers
        if amount % 1 == 0:
            amount = int(amount)
        elif amount * 10 % 1 == 0:
